...
export class NivelesComponent implements OnInit, AfterViewInit, OnDestroy {
  titleListNiveles: string;
  subtitleListNiveles: string;
  nameBtnAdd: string;
  nameBtnEdit: string;
  ...
  constructor(
    ...
    this.titleListNiveles = 'ESCUELA DE FORMACIÓN DEPORTIVA';
    this.subtitleListNiveles = 'Niveles';
