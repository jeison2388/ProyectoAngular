...
export class ProductosComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
     ...
     ******************************************/
    const that = this;
    this.dataService.contar('Proveedor').subscribe((data: any) => {
      this.cantidad = data;
    });
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.dataService.entidadBasicaPaginada('Proveedor',
          [
          ...
          [this.id, this.nit, this.nom, this.tel],
          offset,
      ...
      columns: [{ data: 'id' }, { data: 'nit' }, { data: 'nombreComercia' }, { data: 'telefono' }, {}]
    };
  }
  ...
  editar(id): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/cotizaciones/producto'], { queryParams: { id: id } })
    })
  }
  ...
  cancelar(): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/cotizaciones/productos']);
    });
  }
