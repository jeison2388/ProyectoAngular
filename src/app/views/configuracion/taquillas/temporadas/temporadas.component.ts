...
export class TemporadasComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
     ...
     ******************************************/
    const that = this;
    this.dataService.contar('Temporada').subscribe((data: any) => {
      this.cantidad = data;
    });
    ...
    this.dtOptions = {
      ...
      columns: [{ data: 'id' }, { data: 'desde' }, { data: 'hasta' },{}]
    };
  }
  ...
  editar(id): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/taquillas/temporada'], { queryParams: { id: id } })
    })
  }
  ...
  eliminar(id) {
    ...
    */
    ...
    if (confirm('Seguro de eliminar el registro?')) {
      this.dataService.eliminarObjeto('Temporada', id).subscribe((data: any) => {       
        ...
        this.notifier.notify('success', 'La información se ha eliminado correctamente');
          ...
          this.notifier.notify('error', 'No es posible eliminar el objeto');
          console.log(error);  
        }  
      });
    }
  ...
  cancelar(): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/taquillas/temporadas'])
    })
  }
