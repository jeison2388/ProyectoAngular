...
export class TarifasComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
     ...
     ******************************************/
    const that = this;
    this.dataService.contar('VistaTarifas').subscribe((data: any) => {
      this.cantidad = data;
    });
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.dataService.entidadBasicaPaginada('VistaTarifas',
          [
          ...
          [this.id, this.cod, this.des, this.tip, this.gru],
          offset,
      ...
      columns: [{ data: 'id' }, { data: 'codigo' }, { data: 'descripcion' }, { data: 'tipoServicio' }, { data: 'grupoServicio' }, {}]
    };
  }
  ...
  editar(id): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/taquillas/tarifa'], { queryParams: { id: id } })
    })
  }
  ...
  eliminar(id) {
    ...
    */
    ...
    if (confirm('Seguro de eliminar el registro?')) {
      this.dataService.eliminarObjeto('Tarifa', id).subscribe((data: any) => {       
  ...
  cancelar(): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/taquillas/tarifas'])
    })
  }
