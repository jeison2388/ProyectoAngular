...
export class AperturasComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit() {
     ...
     ******************************************/
    const that = this;
    this.dataService.contar('Apertura').subscribe((data: any) => {
      this.cantidad = data;
    });
  ...
  editar(id): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/taquillas/apertura'], { queryParams: { id: id } })
    })
  }
  ...
  eliminar(id) {
    ...
    */
    ...
    if (confirm('Seguro de eliminar el registro?')) {
      this.dataService.eliminarObjeto('Apertura', id).subscribe((data: any) => {       
  ...
  cancelar(): void {
    this.router.navigateByUrl('dummy', { skipLocationChange: true }).then(() => {
      this.router.navigate(['/taquillas/aperturas'])
    })
  }
