...
export class ListInscritosComponent implements OnInit, AfterViewInit, OnDestroy {
  title: string;
  subtitle: string;
  nameBtnBack: string;
  ...
  constructor(
    ...
    this.title = 'LISTADO';
    this.subtitle = 'Nivelss Inscritos';
  ...
  ngOnInit() {
    ...
    this.dtOptions = {
      ...
      columns: [{ data: 'id' }, { data: 'codigo' }, { data: 'descripcion' }, { data: 'programa' }, { data: 'nivel' }]
    };
  }
